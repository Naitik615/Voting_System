...
export const canisterId = process.env.CANISTER_ID_DVOTE_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./dvote_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the dvote_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./dvote_frontend.did.js")._SERVICE>}
 */
export const dvote_frontend = createActor(canisterId);
