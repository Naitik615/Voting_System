...
export const canisterId = process.env.CANISTER_ID_DVOTE_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./dvote_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the dvote_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./dvote_backend.did.js")._SERVICE>}
 */
export const dvote_backend = createActor(canisterId);
