...
function FpLegendre(Fp4, n) {
  const legc = (Fp4.ORDER - _1n2) / _2n;
  const powered = Fp4.pow(n, legc);
...
function montgomery(curveDef) {
  ...
  const adjustScalarBytes2 = CURVE.adjustScalarBytes || ((bytes) => bytes);
  const powPminus2 = CURVE.powPminus2 || ((x) => Fp4.pow(x, P - BigInt(2)));
...
`);
  ...
  async syncTime(canisterId) {
    await __classPrivateFieldGet4(this, _HttpAgent_instances, "m", _HttpAgent_rootKeyGuard).call(this);
    const CanisterStatus = await import("./canisterStatus-J47BFE4P.js");
...
*/
//# sourceMappingURL=chunk-VZ7FOB7V.js.map
